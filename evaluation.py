...
epoch_1_folder = os.path.join(MODEL_FOLDER, epochs[0])
peft_model = PeftModel.from_pretrained(multi_model, epoch_1_folder)
...
for i, epoch in enumerate(epochs, 1):
    ...
    peft_model.load_adapter(epoch_folder, adapter_name="default")
    peft_model.set_adapter("default")

    peft_model.to(device)
    peft_model.eval()

    # ADD ACTUAL EVAL SCRIPT AND SAVE RESULTS